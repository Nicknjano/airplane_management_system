...
from airline_management.views import index,home,booking_view,booking2,contactus,user,new_flight,manageflights,newairbus,accounts,payement,login_user,itinerary,delete_flight,add_airbus
